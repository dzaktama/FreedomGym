                    ...
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                <span class="month">Visit</span>
                                <p class="mb-25">Rp25.000  <span>(1 Orang)</span></p><br>
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="assets/img/icon/check.svg" alt="">
                                    </div>
                                    <div class="features-caption">
                                        <p>Akses full selama Sehari 24 jam </p>
                                    </div>
                                </div>
                                <div class="single-features">
                                    <div class="features-icon">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                <span class="month">Individual</span>
                                <p class="mb-25">Rp95.000<span> (1 Orang)</span></p>
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="assets/img/icon/check.svg" alt="">
                                    </div>
                                    <div class="features-caption">
                                        <p>Akses gym full selama 1 hari</p>
                                    </div>
                                </div>
                                <div class="single-features">
                                    <div class="features-icon">
                                    ...
                                    <div class="features-caption">
                                        <p>Sesi kelas kelompok (yoga, HIIT, atau functional training)</p>
                                    </div>
                                </div>
                                <div class="single-features">
                                    <div class="features-icon">
                                    ...
                                    <div class="features-caption">
                                        <p>1 Personal Trainer untuk 4 orang</p>
                                    </div>
                                </div>
                                <div class="single-features">
                                    <div class="features-icon">
                                ...
                                <div class="single-features mb-20">
                                    ...
                                    <div class="features-caption">
                                        <p>Kamar mandi, shower, dan loker pribadi</p>
                                    </div>
                                </div>
                                <a href="register.php" class="border-btn border-btn2">Join Now</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                <span class="month">Squad</span>
                                <p class="mb-25">Rp300.000<span> (4 orang)</span></p>
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="assets/img/icon/check.svg" alt="">
                                    </div>
